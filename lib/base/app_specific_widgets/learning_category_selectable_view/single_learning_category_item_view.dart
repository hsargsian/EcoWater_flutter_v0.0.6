...
enum SingleLearningCategoryItemViewType {
  normal,
  horizontalSelectable;

  double get contentPadding {
    switch (this) {
      case SingleLearningCategoryItemViewType.normal:
        return 0;
      case SingleLearningCategoryItemViewType.horizontalSelectable:
        return 15;
    }
  }
...
class SingleLearningCategoryItemView extends StatelessWidget {
  ...
  final SingleLearningCategoryItemViewType type;
