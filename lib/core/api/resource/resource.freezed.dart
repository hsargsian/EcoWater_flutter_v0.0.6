...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'Result<$T>.success(body: $body)';
  }
...
abstract class Success<T> implements Result<T> {
  const factory Success(final T body) = _$SuccessImpl<T>;
...
abstract class _$$ErrorImplCopyWith<T, $Res> {
  ...
  $CustomExceptionCopyWith<$Res> get error;
}
...
class __$$ErrorImplCopyWithImpl<T, $Res>
  ...
  @pragma('vm:prefer-inline')
  $CustomExceptionCopyWith<$Res> get error {
    return $CustomExceptionCopyWith<$Res>(_value.error, (value) {
...
abstract class Error<T> implements Result<T> {
  const factory Error(final CustomException error) = _$ErrorImpl<T>;
